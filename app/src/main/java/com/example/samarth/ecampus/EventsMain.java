...
public class EventsMain extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mStorageRef = FirebaseStorage.getInstance().getReference("uploads_events");
        ...
        mButtonUpload.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mUploadTask != null && mUploadTask.isInProgress()) {
                    Toast.makeText(EventsMain.this, "Upload in progress", Toast.LENGTH_SHORT).show();
                } else {
    ...
    private void uploadFile() {
        if (mImageUri != null) {
            ...
            final StorageReference imageFolder = mStorageRef.child("/"+eventName);

            mStorageRef.child(""+eventName);
            ...
            mUploadTask = fileReference.putFile(mImageUri)
                    .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            Toast.makeText(EventsMain.this, "Upload successful !!! ", Toast.LENGTH_LONG).show();

                            fileReference.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                                @Override
                                public void onSuccess(Uri uri) {
                                    //set value for newCategory if image Uploaded and we can get download link
                                    UploadEvent upload = new UploadEvent(mEditTextFileName.getText().toString(),uri.toString());
                    ...
                    .addOnFailureListener(new OnFailureListener() {
                        ...
                        public void onFailure(@NonNull Exception e) {
                            Toast.makeText(EventsMain.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                        }
                    })
